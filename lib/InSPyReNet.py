...
from lib.backbones.MobileNetV2 import MobileNetV2
...
def InSPyReNet_MobileNetV2(depth, pretrained, base_size, **kwargs):
    return InSPyReNet(MobileNetV2(pretrained=pretrained), [16, 24, 32, 96, 1280], depth, base_size, **kwargs)
